...
import { LocalizedText } from "../components/LocalizeText";
      ...
      <div className="px-4 py-24 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-6xl font-extrabold text-gray-800 sm:text-center">
            <LocalizedText t={"ACCOUNT.ACCOUNT"} />
          </h1>
          <p className="mt-5 text-xl text-gray-500 sm:text-center">
            <LocalizedText t={"ACCOUNT.STRIPE_BILLING"} />
          </p>

          <div className="mt-12 bg-white shadow sm:rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg font-medium leading-6 text-gray-900">
                <LocalizedText t={"ACCOUNT.MANAGE_SUBSCRIPTION"} />
              </h3>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-yellow-700">
                        <LocalizedText t={"ACCOUNT.SUBSCRIPTION_END"} />{" "}
              ...
              <div className="mt-2 sm:flex sm:items-start sm:justify-between">
                <div className="max-w-xl text-sm text-gray-500">
                  <p>
                    <LocalizedText t={"ACCOUNT.LOREM_IPSUM"} />
                  </p>
                </div>
                <div className="mt-5 sm:mt-0 sm:ml-6 sm:flex-shrink-0 sm:flex sm:items-center">
                  {!!subscription ? (
                    ...
                    >
                      <LocalizedText t={"ACCOUNT.CHANGE_PLAN"} />
                    </button>
                  ) : (
                    <Link href="/">
                      <button
                        ...
                        className="inline-flex items-center px-4 py-2 font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:text-sm"
                      >
                        <LocalizedText t={"ACCOUNT.SUBSCRIBE"} />
                      </button>
                    </Link>
                  )}
                </div>
